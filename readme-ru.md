...
Во многих случаях директорию "dynamic/cache" можно организовать
в оперативной памяти. Для повышения уровня надёжности такая оперативная
память должна поддерживать ECC (error-correcting code).
