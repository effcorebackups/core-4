...
namespace effectivecore {
  ...
  require_once('system/module_core/code/class--gl--file.php');
  require_once('system/module_core/code/factory--gl--timer.php');
  require_once('system/module_core/code/factory--gl.php');
  require_once('system/module_core/code/factory--gl--cache.php');
  require_once('system/module_core/code/factory--gl--file.php');
  require_once('system/module_core/code/factory--gl--console.php');
  require_once('system/module_core/code/factory--gl--message.php');
