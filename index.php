...
namespace effectivecore {
  ...
  require_once('system/module_core/backend/class_ab--gl--factory.php');
  require_once('system/module_core/backend/class_ab--gl--timer.php');
  require_once('system/module_core/backend/class_ab--gl--console.php');
  require_once('system/module_core/backend/class_ab--gl--dynamic.php');
  require_once('system/module_core/backend/class_ab--gl--cache.php');
  ...
  # case for protected files
    if (!empty($file_types[$extension]->protected)) {
      factory::send_header_and_exit('access_denided',
        'file with this extension is protected in file: file_types.data'.br.'go to <a href="/">front page</a>'
      );
    }
