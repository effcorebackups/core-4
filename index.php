...
namespace effectivecore {
  ...
  require_once('system/module_core/code/gl--factory--timer.php');
  require_once('system/module_core/code/gl--file.php');
  require_once('system/module_core/code/gl--factory.php');
  require_once('system/module_core/code/gl--factory--cache.php');
  require_once('system/module_core/code/gl--factory--file.php');
  require_once('system/module_core/code/gl--factory--console.php');
  require_once('system/module_core/code/gl--factory--message.php');
